...
<ul style={{ listStyleType: 'none', color: '#FEE56E'}}>
  <Appear>
    <li><h3 style={{ margin: '5px' }}>Fast</h3></li>
    <li><h3 style={{ margin: '5px' }}>Reliable</h3></li>
    <li><h3 style={{ margin: '5px' }}>Isolated</h3></li>
    <li><h3 style={{ margin: '5px' }}>Readable</h3></li>
  </Appear>
</ul>
...
<ul style={{listStyleType: 'none', color: '#E12B2E'}}>
  <li>Static "Util" Methods</li>
