...
const AREAS_MAP = {
  name: 'topology-map',
  areas: [
    { shape: 'rect', coords: [514,244,251,93] },
    { shape: 'circle', coords: [374,554,152] },
    { shape: 'circle', coords: [379,995,157] },
    { shape: 'circle', coords: [378,1481,173] },
    { shape: 'circle', coords: [384,1978,147] },
    { shape: 'circle', coords: [381,2422,147] },
    { shape: 'poly', coords: [1120,253,1124,603,1462,598,1460,265] },
    { shape: 'poly', coords: [1706,348,1712,518,1935,507,1939,354] },
    { shape: 'circle', coords: [1284,915,156] },
    { shape: 'circle', coords: [1827,923,160] },
    { shape: 'circle', coords: [1290,1366,161] },
    { shape: 'circle', coords: [1822,1358,153] },
    { shape: 'rect', coords: [2109,1736,2328,1870] },
    { shape: 'circle', coords: [1288,1804,148] },
    { shape: 'rect', coords: [1127,2088,1460,2254] },
  ]
}
...
<StyledSurfer fontSize={26}>
  <CodeSurfer
      ...
      language="groovy"
      title="KTable Spec - EmbeddedKafka"
      steps={[
        { range: [1,  31] },
...
<StyledSurfer fontSize={22}>
  <CodeSurfer
      ...
      language="groovy"
      title="Full Streams Embedded Spec"
      steps={[
        { range: [1, 83] },
...
<https://github.com/msschroe3/spring-kafka-samples>